...
const fhss_config_t domains[] = {
    {"R150", FREQ_HZ_TO_REG_VAL(130500000), FREQ_HZ_TO_REG_VAL(169900000), 40, 150000000},
    {"R300", FREQ_HZ_TO_REG_VAL(280500000), FREQ_HZ_TO_REG_VAL(319900000), 40, 300000000},
    {"R433", FREQ_HZ_TO_REG_VAL(413500000), FREQ_HZ_TO_REG_VAL(452900000), 40, 433000000},
    {"R600", FREQ_HZ_TO_REG_VAL(580500000), FREQ_HZ_TO_REG_VAL(619900000), 40, 600000000},
    {"R720", FREQ_HZ_TO_REG_VAL(700500000), FREQ_HZ_TO_REG_VAL(739900000), 40, 720000000},
    {"R868", FREQ_HZ_TO_REG_VAL(848500000), FREQ_HZ_TO_REG_VAL(887900000), 40, 868000000},
    {"R915", FREQ_HZ_TO_REG_VAL(895500000), FREQ_HZ_TO_REG_VAL(934900000), 40, 915000000},
    {"R950", FREQ_HZ_TO_REG_VAL(930000000), FREQ_HZ_TO_REG_VAL(970000000), 40, 950000000},
...
const fhss_config_t domainsDualBand[] = {
    {"R2100",  FREQ_HZ_TO_REG_VAL(2050000000), FREQ_HZ_TO_REG_VAL(2150000000), 50, 2100000000},
