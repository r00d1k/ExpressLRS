...
const fhss_config_t domains[] = {
    ...
    {"UA720-760", FREQ_HZ_TO_REG_VAL(720000000), FREQ_HZ_TO_REG_VAL(759500000), 40, 740000000},
    {"UA760-800", FREQ_HZ_TO_REG_VAL(760000000), FREQ_HZ_TO_REG_VAL(799500000), 40, 780000000},    
    {"UA790-830", FREQ_HZ_TO_REG_VAL(790000000), FREQ_HZ_TO_REG_VAL(829500000), 40, 810000000},
    {"UA830-870", FREQ_HZ_TO_REG_VAL(830000000), FREQ_HZ_TO_REG_VAL(869500000), 40, 850000000},
    {"UA870-910", FREQ_HZ_TO_REG_VAL(870000000), FREQ_HZ_TO_REG_VAL(909500000), 40, 890000000},
    {"UA910-950", FREQ_HZ_TO_REG_VAL(910000000), FREQ_HZ_TO_REG_VAL(949500000), 40, 930000000},
    {"UA950-990", FREQ_HZ_TO_REG_VAL(950000000), FREQ_HZ_TO_REG_VAL(989500000), 40, 970000000},
};
...
const fhss_config_t domains[] = {
    ...
    {"UA130-170", FREQ_HZ_TO_REG_VAL(130500000), FREQ_HZ_TO_REG_VAL(169900000), 40, 150000000},
    {"UA280-320", FREQ_HZ_TO_REG_VAL(280500000), FREQ_HZ_TO_REG_VAL(319900000), 40, 300000000},
    {"UA413-453", FREQ_HZ_TO_REG_VAL(413500000), FREQ_HZ_TO_REG_VAL(452900000), 40, 433000000},
    {"UA580-620", FREQ_HZ_TO_REG_VAL(580500000), FREQ_HZ_TO_REG_VAL(619900000), 40, 600000000},
    {"UA670-710", FREQ_HZ_TO_REG_VAL(670000000), FREQ_HZ_TO_REG_VAL(710000000), 40, 690000000},
    {"UA700-740", FREQ_HZ_TO_REG_VAL(700500000), FREQ_HZ_TO_REG_VAL(739900000), 40, 720000000},
    {"UA848-888", FREQ_HZ_TO_REG_VAL(848500000), FREQ_HZ_TO_REG_VAL(887900000), 40, 868000000},
    {"UA895-935", FREQ_HZ_TO_REG_VAL(895500000), FREQ_HZ_TO_REG_VAL(934900000), 40, 915000000},
    {"UA930-970", FREQ_HZ_TO_REG_VAL(930000000), FREQ_HZ_TO_REG_VAL(970000000), 40, 950000000},
    
    {"UA720-760 (SX1276)", FREQ_HZ_TO_REG_VAL(720000000), FREQ_HZ_TO_REG_VAL(759500000), 40, 740000000},
    {"UA760-800 (SX1276)", FREQ_HZ_TO_REG_VAL(760000000), FREQ_HZ_TO_REG_VAL(799500000), 40, 780000000},    
    {"UA790-830 (SX1276)", FREQ_HZ_TO_REG_VAL(790000000), FREQ_HZ_TO_REG_VAL(829500000), 40, 810000000},
    {"UA830-870 (SX1276)", FREQ_HZ_TO_REG_VAL(830000000), FREQ_HZ_TO_REG_VAL(869500000), 40, 850000000},
    {"UA870-910 (SX1276)", FREQ_HZ_TO_REG_VAL(870000000), FREQ_HZ_TO_REG_VAL(909500000), 40, 890000000},
    {"UA910-950 (SX1276)", FREQ_HZ_TO_REG_VAL(910000000), FREQ_HZ_TO_REG_VAL(949500000), 40, 930000000},
    {"UA950-990 (SX1276)", FREQ_HZ_TO_REG_VAL(950000000), FREQ_HZ_TO_REG_VAL(989500000), 40, 970000000},
...
const fhss_config_t domainsDualBand[] = {
    ...
    {"UA2050-2150",  FREQ_HZ_TO_REG_VAL(2050000000), FREQ_HZ_TO_REG_VAL(2150000000), 50, 2100000000},
    {"UA2540-2640", FREQ_HZ_TO_REG_VAL(2540000000), FREQ_HZ_TO_REG_VAL(2640000000), 50, 2590000000},
};
